...
export default function DoctorProfilePage() {
  ...
  /* ── Shared sidebar/booking blocks (reused in mobile & desktop) ── */
  const bookingCard = !bookingDone ? (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="p-4 sm:p-5 space-y-5">
        ...
        {/* Date picker — scrollable, shows ~4 dates */}
        <div>
        ...
        {/* Time slots — 2 per row on all sizes */}
        <div>
  ...
  const queueWidget = doctor.availableToday ? (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 w-full">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            {/* Mobile-only: Share card at bottom */}
